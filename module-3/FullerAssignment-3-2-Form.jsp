...
<head>
	...
	<title>Fuller Assignment 3.2</title>
</head>
<body>
	<header>
		<h1>Application</h1>
	...
	<div id=container>
		...
		<form name="Brett" action="FullerAssignment-3_2-DisplayResults.jsp" method="post">
	       ...
	       <br />
	       <br />
	       <%--Selection box to select the highest level of exucation --%>
	       <label class=left>
