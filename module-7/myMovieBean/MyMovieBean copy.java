//Brett Fuller
//CSD-430 Assignment 5 and 6 and 7
//6/29/2025
...
public class MyMovieBean implements java.io.Serializable{
	...
	public String formUpdate(String requestURL) {
    	...
    	dataStringBuilder.append("<input list='t' name='Title' id='Title'>\n");      	
    	dataStringBuilder.append("<datalist id='t'>\n");   
    	...
    	dataStringBuilder.append("&nbsp&nbsp \n");   
    	dataStringBuilder.append("<input list='d' name='Director' id='Director'>\n");      	
    	dataStringBuilder.append("<datalist id='d'>\n");  
    	...
    	else if ( requestURL.equals("FullerAssignment_8_2-Update.jsp") || requestURL.equals("CRUD_Update.jsp")) {
    	...
    	dataStringBuilder.append("<label for='la'>LeadActor</label>\n");
    	dataStringBuilder.append("&nbsp&nbsp \n");   
    	dataStringBuilder.append("<input list='LeadActor' name='LeadActor' id='LeadActor'>\n");      	
    	...
    	dataStringBuilder.append("<label for='la2'>LeadActress</label>\n");
    	dataStringBuilder.append("&nbsp&nbsp \n");  
    	dataStringBuilder.append("<input list='LeadActress' name='LeadActress' id='LeadActress'>\n");      	
